...
},{"./components/Form.vue":11,"./components/List.vue":12,"jquery":1,"underscore":4,"vue":8,"vue-resource":6,"vue-router":7}],11:[function(require,module,exports){
'use strict';
        ...
        sendForm: function sendForm(event) {
            ...
            this.$http.post('http://shrooms-service.ivan-test.xyz/v1/mushrooms', new FormData(event.target)).then(function (response) {
                if (response.data.mushroom.result == 'e') {
                    ...
                    _toastr2.default.error('Your mushroom is poisonous!', 'Yuck');
                }
            }, function (response) {
                console.log(response);
            });
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-e711e88a", module.exports)
  } else {
